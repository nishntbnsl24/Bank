...
public class deleteaccount extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{accountnumber = Long.parseLong(accnum);}catch(Exception e){JOptionPane.showMessageDialog(this, "AccountNumber must be in numbers");}
        try{password=Integer.parseInt(pin);}catch(Exception e){JOptionPane.showMessageDialog(this, "Password must be in numbers");}
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/bankdatabase","root","");
            Statement stmt=con.createStatement();
            String query="delete from customers where account_number="+accountnumber+" AND password="+password+";";
            if(stmt.executeUpdate(query)==1){
            con.close();
            JOptionPane.showMessageDialog(this,"Account deleted");
            dispose();}
            else JOptionPane.showMessageDialog(this, "Account Not deleted");
